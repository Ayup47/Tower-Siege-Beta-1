...
function setup() {
  ...
  block3 = new Block2(360,275,30,40);
  block4 = new Block2(390,275,30,40);
  block5 = new Block2(420,275,30,40);
  ...
  //top
  block16 = new Block2(390,155,30,40);

  //set 2 for second stand
  //level one
  blocks1 = new Block2(640,175,30,40);
  blocks2 = new Block2(670,175,30,40);
  blocks3 = new Block2(700,175,30,40);
  blocks4 = new Block2(730,175,30,40);
  blocks5 = new Block2(760,175,30,40);
  //level two
